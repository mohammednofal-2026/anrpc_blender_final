...
class _GasolineProCalculatorState extends State<GasolineProCalculator> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Gasoline Pro Blending", style: TextStyle(fontSize: 14)),
        actions: [
              ...
              SingleChildScrollView(
                ...
                child: ConstrainedBox(
                  ...
                  child: DataTable(
                    ...
                    columns: ['Tank', 'Prod', 'Level', 'Oct', 'Sens', 'Ar%', 'Ben%', 'RVP', 'S']
  ...
  Widget _buildFinalSpecPanel() {
    return Container(
      ...
      child: Column(
        children: [
          Text("FINAL BLENDING SPECIFICATIONS", style: TextStyle(color: Colors.orangeAccent, fontSize: 11, fontWeight: FontWeight.bold)),
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Text("App by Mohammed Nofal", style: TextStyle(color: Colors.blue[900], fontSize: 12)),
  ...
  Widget _recipeBox() => Container(
    ...
    child: Column(
      children: [
        _recipeRow("GRADE", "$productGrade ($season)"),
  ...
  Widget _recipeRow(String l, String v) => Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [Text(l, style: TextStyle(color: Colors.black87, fontSize: 10)), Text(v, style: TextStyle(color: Colors.black, fontSize: 11, fontWeight: FontWeight.bold))]);
